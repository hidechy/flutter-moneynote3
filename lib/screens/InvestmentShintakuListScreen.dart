...
class InvestmentShintakuListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final investmentShintakuState = ref.watch(investmentShintakuProvider);
      ...
      children: [
        ...
        ListView.separated(
          itemBuilder: (context, index) {
            var exData = investmentShintakuState[index].toString().split(';');
                      ...
                      child: GestureDetector(
                        onTap: () {
                          showDialog(
                            context: context,
                            builder: (_) {
                              return InvestmentShintakuGraphScreen(
                                data: exData[6],
                              );
                            },
                          );
          ...
          itemCount: investmentShintakuState.length,
        ),
      ],
    );
  }
...
class InvestmentShintakuGraphScreen extends StatelessWidget {
  InvestmentShintakuGraphScreen({Key? key, required this.data})
      : super(key: key);
